...
<footer class="navbar navbar-fixed-bottom mt-5">
    <div class="container " style="background-color: #aaa"">
        <div class="row ">
            <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3 mt-2 mb-2">
                <img class="" style="height: 100%; width:80%" src="../../images/escuelajulogo.png" alt="" srcset="">
            </div>
            <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3  text-center mt-3">
                <ul class="">
                <li style="list-style: none; font-weight: bold;
                font-size: 20px; color:#dbad3a !important">Explorar</li>
                <li style="list-style: none; color:#fff !important">Inicio</li>
                <li style="list-style: none; color:#fff !important ">Cursos</li>
                <li style="list-style: none; color:#fff !important">Perfil</li>
              </ul></div>
