...
<nav class="navbar fixed-top navbar-expand-lg navbar-light bg-none navbar-center  " style="padding: 0;" >
    <div class="container-fluid linedown " >
        ...
        <ul class="nav nav-fill" style="background-color: #dbad3a !important">
            ...
            <li class="nav-item {{ setActive('curso.index')}}">
                <a class="nav-link" href="{{ route('curso.index')}}"><svg class="" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#4c0d0d" class="bi bi-book mt-2" viewBox="0 0 16 16">
            ...
            <li class="nav-item  {{ setActive('perfil.*')}}">
                <a class="nav-link" href="{{ route('perfil.index')}}"><svg class="" style="" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#4c0d0d" class="bi bi-person " viewBox="0 0 16 16">
                    <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0zm4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4zm-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10z"/>
                  </svg>Mi Perfil</a>
            </li>
            <li class="nav-item {{ setActive('usuario.*')}}">
                <a class="nav-link " href="{{ route('usuario.index')}}"><svg class="" style="" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#4c0d0d" class="bi bi-people ml-4 mt-2" viewBox="0 0 16 16">
            ...
            <li class="nav-item {{ setActive('curso.create')}}">
                <a class="nav-link " href="{{ route('curso.create')}}"><svg class="" style="" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#4c0d0d" class="bi bi-file-earmark-plus ml-5 mt-2" viewBox="0 0 16 16">
        ...
        <div class=" row  " style="background-color: rgba(187, 150, 80); " >
