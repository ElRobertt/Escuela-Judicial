    ...
    <div class="container-fluid linedown " >
        <div " class=" row mb-0 d-flex justify-content-center" style="background-color: white; padding: 0;">
            ...
            <div class="col-12 col-sm-12 mt-3 col-md-6 col-lg-6 col-xl-6 offset-lg-0" style="max-width: 460px; background-color: white">
                <img class="rounded img-fluid  col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 " src="../../images/escuelajulogo.png" alt="" srcset="">
            </div>
        </div>
        <div class="row ssh" style="background-color: none !important"">
            <div class="col-12 col-sm-12 col-lg-2 col-xl-2 text-center ass " style="background-color: none ; " >
                <a style="font-size:16px !important" class="btn  nav-link" data-toggle="collapse" href="#multiCollapseExample1" data-target=".multi-collapse" role="button" aria-expanded="false" aria-controls="multiCollapseExample1 multiCollapseExample2">
                    <svg  xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#4c0d0d" class="bi bi-list mt-1" viewBox="0 0 16 16">
        ...
        <ul class="mx nav nav-fill" style="background-color: #dbad3a !important">
            <li class="nav-item {{ setActive('inicio.*')}}">
                <a class="nav-link active " href="{{ route('inicio.index')}}"><svg class="mr-1 " style="margin-top: -5px" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#4c0d0d" class="bi bi-house  mt-2" viewBox="0 0 16 16">
                    <path fill-rule="evenodd" d="M2 13.5V7h1v6.5a.5.5 0 0 0 .5.5h9a.5.5 0 0 0 .5-.5V7h1v6.5a1.5 1.5 0 0 1-1.5 1.5h-9A1.5 1.5 0 0 1 2 13.5zm11-11V6l-2-2V2.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5z"/>
                    <path fill-rule="evenodd" d="M7.293 1.5a1 1 0 0 1 1.414 0l6.647 6.646a.5.5 0 0 1-.708.708L8 2.207 1.354 8.854a.5.5 0 1 1-.708-.708L7.293 1.5z"/>
                </svg>Inicio</a>
            </li>
            <li class="nav-item {{ setActive('curso.index')}}">
                <a class="nav-link " href="{{ route('curso.index')}}"><svg class="mr-1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#4c0d0d" class="bi bi-book mt-2  " viewBox="0 0 16 16">
            ...
            <li class="nav-item  {{ setActive('perfil.*')}}">
                <a class="nav-link" href="{{ route('perfil.index')}}"><svg class="mr-1" style="" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#4c0d0d" class="bi bi-person " viewBox="0 0 16 16">
                    <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0zm4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4zm-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10z"/>
                  </svg>Mi Perfil</a>
            </li>
            @if (auth()->user()->hasRoles(1))
            <li class="nav-item {{ setActive('usuario.*')}}">
                <a class="nav-link " href="{{ route('usuario.index')}}"><svg class="mr-1" style="" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#4c0d0d" class="bi bi-people ml-4 mt-2" viewBox="0 0 16 16">
            ...
            <li class="nav-item {{ setActive('curso.create')}}">
                <a class="nav-link " href="{{ route('curso.create')}}"><svg class="mr-1" style="" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#4c0d0d" class="bi bi-file-earmark-plus ml-5 mt-2" viewBox="0 0 16 16">
            ...
            @else
            <li class="nav-item dropdown " style="list-style: none collapse multi-collapse">
                <a id="navbarDropdown" class="nav-link dropdown-toggle " href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                  {{auth()->user()->name}}
                </a>

                <div class="dropdown-menu " style=" list-style: none; " aria-labelledby="navbarDropdown">
        ...
        <div class=" row  mx2" style="background-color: rgba(187, 150, 80); " >
