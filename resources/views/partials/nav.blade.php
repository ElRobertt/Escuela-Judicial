    ...
    <div class="container-fluid linedown " >
        <div class="row mb-0 d-flex justify-content-center" style="background-color: none; padding: 0;">
            ...
            <div class="col-6" style="background-color: white">
                <img class="rounded float-right logos" src="../../images/escuelajulogo.png" alt="" srcset="">
            </div>
        </div>
        <div class="row">
        ...
        <div class="row align-items-center d-flex justify-content-center" style="background-color: rgba(187, 150, 80); ">
                ...
                <div class=" " id="navbarTogglerDemo01">
                    <ul class="navbar-nav  ">
                      <li class="nav-item {{ setActive('inicio.*')}}">
                          ...
                          <a class="nav-link ass "  href="{{ route('inicio.index')}}"> <svg class="mr-1 " style="margin-top: -5px" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#4c0d0d" class="bi bi-house ml-3 mt-2" viewBox="0 0 16 16">
            ...
            <div class="col-2 d-flex justify-content-center ">
                <li class="nav-item text-center {{ setActive('curso.index')}}" style="list-style: none">
                    ...
                    <a class="nav-link ass" href="{{ route('curso.index')}}"> <svg class="mr-1 " style="margin-top: -5px" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#4c0d0d" class="bi bi-book ml-1 mt-2" viewBox="0 0 16 16">
