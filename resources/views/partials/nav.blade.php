        ...
        <div class=" row d-flex justify-content-left  " style="background-color: rgba(187, 150, 80); ">
            <div class="col-12 col-sm-12 col-lg-2 col-xl-2 mt-1 collapse multi-collapse " id="multiCollapseExample1" >
                <div class="ml-3 " id="navbarTogglerDemo01">
                    <ul class="navbar-nav  ">
                      <li class="nav-item col-12 {{ setActive('inicio.*')}}">
                     ...
                     <li class="nav-item col-12 {{ setActive('perfil.*')}}" style="list-style: none">
                     ...
                     <li style="list-style: none" class="nav-item col-12 {{ setActive('usuario.*')}}">
                    ...
                    <li class="nav-item col-12 dropdown mt-1" style="list-style: none">
